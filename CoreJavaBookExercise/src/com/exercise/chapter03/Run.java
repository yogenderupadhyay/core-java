...
public class Run {
	...
	System.out.println("Exercise_5 : "
			+ "\n\t\tWrite a program to accept two numbers and check if the first is divisible by the second. In addition,"
			+ "\n\t\t an error should be displayed if the second  number is zero. ");
	System.out.println("\n\t\t\t\t\t\tAdditional Exercise\n");
	...
	case 4: Exercise_4 ex4=new Exercise_4();
			ex4.primeNumbers();
			break;
	case 5: Exercise_5 ex5=new Exercise_5();
			ex5.checkDivisibility();
			break;
	case 6: Exercise_6 ex6=new Exercise_6();
			ex6.table();
			break;
